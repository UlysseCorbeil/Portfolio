...
set runtimepath=
set runtimepath+=~/.vim
set runtimepath+=~/.vim/pack/vim-javascript/start/vim-javascript
...
set runtimepath+=~/.vim/plugged/vim-alias
set runtimepath+=~/.vim/plugged/auto-pairs
set runtimepath+=~/.vim/plugged/coc.nvim
set runtimepath+=~/.vim/plugged/vim-devicons
set runtimepath+=/usr/local/Cellar/macvim/8.1-161/MacVim.app/Contents/Resources/vim/vimfiles
set runtimepath+=/usr/local/Cellar/macvim/8.1-161/MacVim.app/Contents/Resources/vim/runtime
set runtimepath+=~/.vim/pack/vim-javascript/start/vim-javascript/after
set runtimepath+=/usr/local/Cellar/macvim/8.1-161/MacVim.app/Contents/Resources/vim/vimfiles/after
set runtimepath+=~/.vim/plugged/tern_for_vim/after
...
exe 'vert 1resize ' . ((&columns * 101 + 100) / 201)
exe '2resize ' . ((&lines * 33 + 34) / 69)
exe 'vert 2resize ' . ((&columns * 101 + 100) / 201)
exe 'vert 3resize ' . ((&columns * 99 + 100) / 201)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
silent! normal! zE
let s:l = 16 - ((7 * winheight(0) + 16) / 33)
...
wincmd w
argglobal
if bufexists("src/style/style.less") | buffer src/style/style.less | else | edit src/style/style.less | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
inoremap <buffer> <silent> <expr> <M-p> AutoPairsToggle()
...
wincmd w
argglobal
if bufexists("src/modules/ChangeStateOnScroll.js") | buffer src/modules/ChangeStateOnScroll.js | else | edit src/modules/ChangeStateOnScroll.js | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
inoremap <buffer> <silent> <expr> <M-p> AutoPairsToggle()
...
tabnext 1
badd +17 src/App.js
badd +1 src/modules/ChangeStateOnScroll.js
badd +0 src/style/style.less
